...
public class Project {
  ...
  @JoinTable(
      ...
      joinColumns = @JoinColumn(name = "projects_project_id"),  // Clave foránea hacia proyectos
      inverseJoinColumns = @JoinColumn(name = "technologies_tech_id")  // Clave foránea hacia tecnologías
  )
  ...
  @JoinTable(
      ...
      joinColumns = @JoinColumn(name = "projects_project_id"),  // Clave foránea hacia proyectos
      inverseJoinColumns = @JoinColumn(name = "developers_dev_id")  // Clave foránea hacia desarrolladores
  )
